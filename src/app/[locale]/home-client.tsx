...
type Props = {
  heroItems: StoreProduct[];
  trendingItems: StoreProduct[];
};

export default function HomeClient({ heroItems, trendingItems }: Props) {
  const t = useTranslations("Home");

  return (
    <div className="pb-24 md:pb-20">
      <HeroCarousel initialSlides={heroItems} />

      <LazyWhenVisible minHeight="min-h-[360px] md:min-h-[280px]" rootMargin="80px 0px">
        <TrendingProductsSection initialItems={trendingItems} />
      </LazyWhenVisible>
